...
$cases = @(
    @{ Id="T01"; Categoria="Reserva completa con enlace"; Pregunta="Hola, quiero reservar limpieza facial profunda manana a las 10:00 en Providencia"; Intent="reservar_hora"; Min=70; Must=@("limpieza facial profunda", "providencia", "10:00"); MustAny=@("reservas/confirmar", "no encontre disponibilidad"); MustNot=@("si falta sucursal", "que sucursal", "en que sucursal", "voy a validar") },
    @{ Id="T02"; Categoria="Reserva completa depilacion"; Pregunta="Quiero reservar depilacion bozo manana a las 14:00 en Providencia"; Intent="reservar_hora"; Min=70; Must=@("depilacion bozo", "providencia", "14:00"); MustAny=@("reservas/confirmar", "no encontre disponibilidad"); MustNot=@("que servicio quieres", "que sucursal", "en que sucursal", "voy a validar") },
    @{ Id="T03"; Categoria="Falta servicio"; Pregunta="Quiero reservar manana a las 10:00 en Providencia"; Intent="reservar_hora"; Min=50; Must=@("servicio"); MustNot=@("reservas/confirmar") },
    @{ Id="T04"; Categoria="Falta sucursal"; Pregunta="Quiero reservar limpieza facial profunda manana a las 10:00"; Intent="reservar_hora"; Min=70; Must=@("sucursal"); MustNot=@("reservas/confirmar") },
    @{ Id="T05"; Categoria="Falta fecha"; Pregunta="Quiero reservar limpieza facial profunda en Providencia"; Intent="reservar_hora"; Min=70; Must=@("dia"); MustNot=@("reservas/confirmar") },
    @{ Id="T06"; Categoria="Falta hora"; Pregunta="Quiero reservar limpieza facial profunda manana en Providencia"; Intent="reservar_hora"; Min=70; Must=@("hora"); MustNot=@("reservas/confirmar") },
    @{ Id="T07"; Categoria="Reenvio enlace"; Pregunta="No me llego el link de confirmacion, me lo puedes reenviar?"; Intent="reenviar_enlace_confirmacion"; Min=70; Must=@("enlace", "reserva"); MustNot=@("que servicio quieres") },
    @{ Id="T08"; Categoria="Reprogramacion"; Pregunta="Quiero cambiar mi hora"; Intent="reprogramar_reserva"; Min=70; Must=@("reprogramar", "dia", "horario"); MustNot=@("que servicio quieres") },
    @{ Id="T09"; Categoria="Cancelacion"; Pregunta="Necesito cancelar mi cita de manana"; Intent="cancelar_reserva"; Min=70; Must=@("cancelar", "reserva"); MustNot=@("que servicio quieres") },
    @{ Id="T10"; Categoria="Caso sensible"; Pregunta="Tuve una reaccion en la piel despues del tratamiento"; Intent="caso_sensible_post_tratamiento"; Min=70; Must=@("derivar", "persona"); MustNot=@("que servicio quieres") }
)

Write-Host ""
Write-Host "Ejecutando test funcional V23.4 contra: $analyzeUrl"
...
$outDir = Join-Path (Get-Location) "resultados-test-ia-v23-4"
New-Item -ItemType Directory -Force -Path $outDir | Out-Null
$timestamp = Get-Date -Format "yyyyMMdd_HHmmss"
$csvPath = Join-Path $outDir "resultado_test_ia_negocio_v23_4_$timestamp.csv"
$jsonPath = Join-Path $outDir "resultado_test_ia_negocio_v23_4_$timestamp.json"
$htmlPath = Join-Path $outDir "resultado_test_ia_negocio_v23_4_$timestamp.html"
...
<head>
<meta charset="utf-8" />
<title>Resultado test IA negocio V23.4</title>
<style>
...
<body>
<h1>Resultado test IA negocio V23.4</h1>
