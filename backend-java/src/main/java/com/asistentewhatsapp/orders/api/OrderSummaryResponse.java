...
public record OrderSummaryResponse(UUID id, String orderNumber, UUID customerId, String customerName,
		...
		BigDecimal balanceDue, String currency, LocalDate dueDate, OffsetDateTime createdAt, OffsetDateTime updatedAt) {
}
