...
public record OrderDetailResponse(UUID id, String orderNumber, UUID customerId, String customerName,
		...
		OffsetDateTime updatedAt, List<OrderItemResponse> items, List<OrderPaymentResponse> payments,
