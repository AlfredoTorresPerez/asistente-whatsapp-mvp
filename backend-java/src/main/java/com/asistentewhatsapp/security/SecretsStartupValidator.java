...
public class SecretsStartupValidator implements ApplicationRunner {
    ...
    private static final String[] PLACEHOLDER_PATTERNS = {
        "change-this", "replace-with", "your-", "placeholder", "change-me"
    };
        ...
        for (String[] secret : secretsToCheck) {
            ...
            if (value == null || value.isBlank() || isPlaceholder(value)) {
                throw new IllegalStateException(
                        secret[0] + " (" + secret[1] + ") es obligatorio y no puede ser placeholder en ambientes no locales.");
            }
        }
    }
