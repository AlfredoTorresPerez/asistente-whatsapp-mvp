...
public class PublicCenterService {
        ...
        return jdbcTemplate.query(
                ...
                (rs, rn) -> {
                    ...
                    return new PromotionItem(
                            ...
                            startsOn != null ? startsOn.toLocalDate() : null,
                            endsOn != null ? endsOn.toLocalDate() : null);
                },
    ...
    private List<LocationItem> findLocations(UUID businessId) {
        return locationRepository.findActive(businessId).stream()
                .map(l -> new LocationItem(
                        l.id(), l.name(), l.address(), l.city(), l.commune(), l.phone(), l.timezone()))
                .toList();
    }
            ...
            return jdbcTemplate.queryForObject(
                    ...
                    (rs, rn) -> {
                        ...
                        return new PageConfig(
                                ...
                                rs.getString("welcome_title"),
                                rs.getString("welcome_subtitle"),
                                rs.getString("about_title"),
                                rs.getString("about_text"),
                                benefits,
                                testimonials,
                                rs.getString("header_logo_url"),
                                rs.getString("hero_image_url"),
                                rs.getBoolean("show_services"),
                                rs.getBoolean("show_promotions"),
                                rs.getBoolean("show_testimonials"));
                    },
                    businessId);
        } catch (Exception e) {
