...
public class AdminUserService {
    ...
    public PagedResponse<AdminUserResponse> listUsers(
        ...
        return administrationJdbcRepository.findAdminUsers(
    ...
    public AdminUserResponse createUser(AuthenticatedUser authenticatedUser, AdminUserRequest request) {
        ...
        AdminUserResponse created = administrationJdbcRepository.insertAdminUser(
                authenticatedUser.businessId(),
                request,
                role,
                status,
                normalizeTimezone(request.timezone(), authenticatedUser.timezone()),
    ...
    public AdminUserResponse updateUser(
        ...
        String role = normalizeRole(request.role());
        String status = normalizeStatus(request.status());
        AdminUserResponse updated = administrationJdbcRepository.updateAdminUser(
                authenticatedUser.businessId(),
                userId,
                request,
                role,
