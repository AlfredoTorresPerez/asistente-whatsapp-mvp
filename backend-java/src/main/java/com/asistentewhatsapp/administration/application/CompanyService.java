...
public class CompanyService {
    ...
    @Transactional
    public CompanySettingsResponse updateCurrent(
        ...
        auditLogJdbcRepository.insert(
                ...
                Map.of(
                        "companyName", businessEntity.getCompanyName(),
                        "businessName", businessEntity.getBusinessName(),
                        "contactEmail", businessEntity.getContactEmail()),
    ...
    private CompanySettingsResponse toResponse(BusinessEntity businessEntity) {
        return new CompanySettingsResponse(
                businessEntity.getId(),
                businessEntity.getCompanyName(),
                businessEntity.getBusinessName(),
                businessEntity.getTimezone(),
                businessEntity.getCurrency(),
                businessEntity.getContactEmail(),
                businessEntity.getSupportPhone(),
