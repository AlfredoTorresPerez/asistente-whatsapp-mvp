...
public record CompanySettingsRequest(
        ...
        @Pattern(
                regexp = "^$|^\\+?[1-9]\\d{7,14}$",
                message = "Ingresa un telefono de soporte valido en formato internacional.")
        @Size(max = 30, message = "El telefono de soporte no puede superar los 30 caracteres.")
        String supportPhone,
