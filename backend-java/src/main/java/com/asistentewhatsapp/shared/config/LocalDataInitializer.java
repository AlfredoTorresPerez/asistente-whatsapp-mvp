...
public class LocalDataInitializer implements ApplicationRunner {
    ...
    private void updateStaleBookings() {
        ...
        int updated = jdbc.update("""
            ...
            "68000000-0000-0000-0000-000000000002", BUSINESS_ID,
            "68000000-0000-0000-0000-000000000001", BUSINESS_ID,
            "68000000-0000-0000-0000-000000000002", BUSINESS_ID,
            "68000000-0000-0000-0000-000000000001", BUSINESS_ID,
            "68000000-0000-0000-0000-000000000002", BUSINESS_ID,
        ...
        if (updated > 0) {
            log.info("Se actualizaron {} bookings con fechas futuras y referencias a servicio/profesional/cabina.", updated);
        } else {
