...
public class AppointmentConfirmationEmailDTO {
	...
	private String aftercareInstructions;
	...
	public String getReservationDetailsUrl() {
		return reservationDetailsUrl;
	}
	public void setReservationDetailsUrl(String reservationDetailsUrl) {
	...
	public void setAftercareInstructions(String aftercareInstructions) {
		this.aftercareInstructions = aftercareInstructions;
	}
