...
public class DashboardJdbcRepository {
    ...
    public long countOpenConversations(
            UUID businessId,
            UUID ownerUserId,
            OffsetDateTime from,
            OffsetDateTime to) {
    ...
    public List<DashboardSeriesPointResponse> loadConversationSeries(
            UUID businessId,
            UUID ownerUserId,
            OffsetDateTime from,
            OffsetDateTime to) {
    ...
    public List<DashboardSeriesPointResponse> loadOrderSeries(
            UUID businessId,
            UUID ownerUserId,
            OffsetDateTime from,
            OffsetDateTime to) {
    ...
    public List<DashboardAppointmentResponse> loadTodayAppointments(
            UUID businessId,
            UUID ownerUserId,
            OffsetDateTime from,
            OffsetDateTime to) {
    ...
    public List<DashboardActivityResponse> loadRecentActivity(
            UUID businessId,
            UUID ownerUserId,
            OffsetDateTime from,
            OffsetDateTime to) {
    ...
    private RowMapper<DashboardSeriesPointResponse> seriesPointRowMapper() {
        return (resultSet, rowNum) -> new DashboardSeriesPointResponse(
                resultSet.getString("label"),
                resultSet.getLong("value"));
    }

    private RowMapper<DashboardAppointmentResponse> appointmentRowMapper() {
        return (resultSet, rowNum) -> new DashboardAppointmentResponse(
    ...
    private RowMapper<DashboardActivityResponse> activityRowMapper() {
        return (resultSet, rowNum) -> new DashboardActivityResponse(
