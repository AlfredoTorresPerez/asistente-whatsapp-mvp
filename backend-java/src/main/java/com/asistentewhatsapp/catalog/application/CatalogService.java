...
public class CatalogService {
    ...
    public PagedResponse<CatalogProductResponse> listProducts(
        ...
        return catalogJdbcRepository.findProducts(
                authenticatedUser.businessId(), resolvedPage, resolvedSize, search, categoryCode, active);
    }
    ...
    @Transactional
    public CatalogProductResponse createProduct(AuthenticatedUser authenticatedUser, UpsertCatalogProductRequest request) {
    ...
    @Transactional
    public CatalogProductResponse updateProductStatus(AuthenticatedUser authenticatedUser, UUID productId, boolean active) {
