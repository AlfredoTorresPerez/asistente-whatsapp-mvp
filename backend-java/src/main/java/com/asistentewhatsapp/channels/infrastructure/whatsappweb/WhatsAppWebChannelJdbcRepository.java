...
public class WhatsAppWebChannelJdbcRepository {
	...
	public UUID upsertChannelAccount(UUID businessId, String sessionKey, String phoneNumber, String status) {
		return jdbcTemplate.queryForObject("""
				...
				on conflict (business_id, phone_number) do update set
				    ...
				    updated_at = now()
				returning id
				""", UUID.class, UUID.randomUUID(), businessId, sessionKey, status);
	}
	...
	public List<WhatsAppWebRecentEventResponse> findRecentEvents(UUID businessId, int limit) {
		return jdbcTemplate.query("""
				...
				limit ?
				""",
				(resultSet, rowNum) -> new WhatsAppWebRecentEventResponse(resultSet.getString("delivery_id"),
