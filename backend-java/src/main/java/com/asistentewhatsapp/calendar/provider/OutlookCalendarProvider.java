...
public class OutlookCalendarProvider implements CalendarProvider {
	...
	public String getAuthUrl(String state, String redirectUri) {
		...
		return "https://login.microsoftonline.com/common/oauth2/v2.0/authorize"
				+ "?client_id=OUTLOOK_CLIENT_ID_NOT_CONFIGURED" + "&redirect_uri=" + redirectUri + "&response_type=code"
				+ "&scope=Calendars.ReadWrite" + "&state=" + state;
	}
	...
	public TokenExchangeResult exchangeCode(String code, String redirectUri) {
		...
		return new TokenExchangeResult("outlook_stub_access_" + System.currentTimeMillis(),
				"outlook_stub_refresh_" + System.currentTimeMillis(), 3600L, "outlook@demo.cl", "outlook_calendar_id");
	}
