...
public class OAuthStateService {
    ...
    public String generateState(UUID businessId, String provider) {
        ...
        jdbcTemplate.update(
                ...
                new MapSqlParameterSource()
                        ...
                        .addValue("redirectUri", null)
                        .addValue("createdAt", now)
                        .addValue("expiresAt", now.plusMinutes(EXPIRY_MINUTES)));
    ...
    private record OAuthStateRow(UUID businessId, String provider, String redirectUri, boolean consumed, OffsetDateTime expiresAt) {}
