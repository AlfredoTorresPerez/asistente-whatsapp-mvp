...
public class ConversationController {
	...
	public ConversationMetricsResponse metrics(@AuthenticationPrincipal AuthenticatedUser authenticatedUser) {
		return conversationService.getMetrics(authenticatedUser);
	}

	@PreAuthorize("hasPermission(#authenticatedUser.businessId(), 'CONVERSATIONS_VIEW')")
	@GetMapping("/api/v1/conversations")
	public PagedResponse<ConversationSummaryResponse> list(@AuthenticationPrincipal AuthenticatedUser authenticatedUser,
	...
	public ConversationDetailResponse detail(@AuthenticationPrincipal AuthenticatedUser authenticatedUser,
	...
	public ConversationDetailResponse create(@AuthenticationPrincipal AuthenticatedUser authenticatedUser,
	...
	public ConversationMessageResponse sendMessage(@AuthenticationPrincipal AuthenticatedUser authenticatedUser,
			@PathVariable UUID conversationId, @Valid @RequestBody SendConversationMessageRequest request) {
	...
	public ConversationDetailResponse assign(@AuthenticationPrincipal AuthenticatedUser authenticatedUser,
			@PathVariable UUID conversationId, @Valid @RequestBody AssignConversationRequest request) {
	...
	public ConversationDetailResponse markRead(@AuthenticationPrincipal AuthenticatedUser authenticatedUser,
			@PathVariable UUID conversationId) {
	...
	public ConversationAiReplyResponse previewAiReply(@AuthenticationPrincipal AuthenticatedUser authenticatedUser,
			@PathVariable UUID conversationId) {
	...
	public ConversationDetailResponse close(@AuthenticationPrincipal AuthenticatedUser authenticatedUser,
			@PathVariable UUID conversationId) {
	...
	public ConversationDetailResponse reopen(@AuthenticationPrincipal AuthenticatedUser authenticatedUser,
			@PathVariable UUID conversationId) {
