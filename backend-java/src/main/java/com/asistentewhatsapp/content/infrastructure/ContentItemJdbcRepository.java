...
public class ContentItemJdbcRepository {
    ...
    public UUID insert(UUID businessId, ContentItemType type, String imagePath, String text, String status, UUID createdBy) {
    ...
    public void update(UUID businessId, UUID id, ContentItemType type, String imagePath, String text, String status, UUID updatedBy, long version) {
        ...
        if (updated == 0) {
            throw new OptimisticLockException("El registro fue modificado por otro usuario. Recargue e intente nuevamente.");
        }
    }
