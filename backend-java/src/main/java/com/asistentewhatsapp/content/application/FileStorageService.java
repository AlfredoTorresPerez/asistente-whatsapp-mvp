...
public interface FileStorageService {
	...
	/**
	 * Guarda un archivo y devuelve la ruta relativa donde se almacenó. El nombre
	 * del archivo debe ser único (generado por el servicio).
	 */
	String store(String businessId, String originalFilename, InputStream inputStream, long contentLength,
			String contentType);
	...
	/**
	 * Elimina un archivo por su ruta relativa. No lanza excepción si el archivo no
	 * existe.
	 */
	...
	/**
	 * Devuelve la URL pública para acceder al archivo. Para almacenamiento local,
	 * puede ser una ruta servida por un controlador.
	 */
	String getPublicUrl(String relativePath);

	/**
	 * Valida que el archivo sea una imagen permitida (PNG, JPG, JPEG, WebP). Lanza
	 * excepción si no es válido.
	 */
