...
public record LeadDetailResponse(UUID id, UUID customerId, UUID conversationId, UUID locationId, String locationName,
		...
		OffsetDateTime createdAt, OffsetDateTime updatedAt, List<LeadNoteResponse> noteHistory) {
}
