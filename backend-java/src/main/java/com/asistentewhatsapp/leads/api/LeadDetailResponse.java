...
public record LeadDetailResponse(UUID id, UUID customerId, UUID conversationId, String firstName, String lastName,
		...
		OffsetDateTime updatedAt, List<LeadNoteResponse> noteHistory) {
}
