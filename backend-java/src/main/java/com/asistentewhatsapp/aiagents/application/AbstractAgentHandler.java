...
abstract class AbstractAgentHandler implements AgentHandler {
	...
	protected AgentRoutingResult result(AgentConversationRequest request, IntentDetectionResult intent,
			AgentType agentType, Map<String, String> entities, List<String> missingData, String response,
			boolean requiresHuman, String handoffReason) {
	...
	private String summary(AgentConversationRequest request, IntentDetectionResult intent, AgentType agentType,
			Map<String, String> entities, String handoffReason) {
