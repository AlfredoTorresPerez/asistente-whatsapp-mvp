...
public class BusinessLocationJdbcRepository {
    ...
    public BusinessLocationRecord findActiveById(UUID businessId, UUID locationId) {
        return findOptionalActiveById(businessId, locationId)
                .orElseThrow(() -> new ResourceNotFoundException("No se encontro una sede activa para la operacion solicitada."));
    }
    ...
    public boolean existsByCode(UUID businessId, String code, UUID excludedLocationId) {
        MapSqlParameterSource parameters = new MapSqlParameterSource()
                .addValue("businessId", businessId)
                .addValue("code", code)
                .addValue("excludedLocationId", excludedLocationId);
        Long count = jdbcTemplate.queryForObject(
                """
                        select count(*)
                        from business_location
    ...
    public UUID insert(
        ...
        jdbcTemplate.update(
                ...
                new MapSqlParameterSource()
                        ...
                        .addValue("city", city)
                        .addValue("commune", commune)
                        .addValue("phone", phone)
                        .addValue("whatsappNumber", whatsappNumber)
    ...
    private RowMapper<BusinessLocationRecord> recordRowMapper() {
        return (resultSet, rowNum) -> new BusinessLocationRecord(
    ...
    public record BusinessLocationRecord(
            UUID id,
            UUID businessId,
            String code,
            String name,
