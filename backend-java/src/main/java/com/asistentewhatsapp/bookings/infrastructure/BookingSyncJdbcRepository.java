...
public class BookingSyncJdbcRepository {
	...
	public void upsertBookingFact(UUID bookingId, UUID businessId, String customerPhone, String customerName,
			String customerManagementId, String serviceName, String locationName, String professionalName,
			OffsetDateTime bookingDate, OffsetDateTime bookingTime, String bookingStatus, UUID conversationId,
		...
		jdbcTemplate.update(
				"""
						...
						""",
				bookingId, businessId, customerPhone, customerName, customerManagementId, serviceName, locationName,
				professionalName, bookingDate, bookingTime, bookingStatus, conversationId, channelOrigin, originIntent,
				bookingCreatedAt);
	}
