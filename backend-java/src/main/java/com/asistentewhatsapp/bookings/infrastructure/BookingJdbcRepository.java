...
public class BookingJdbcRepository {
    ...
    public PagedResponse<BookingSummaryResponse> findBookings(
            UUID businessId,
            int page,
            int size,
            OffsetDateTime from,
    ...
    public BookingDetailResponse findBookingDetail(UUID businessId, UUID bookingId) {
        ...
        return new BookingDetailResponse(
                base.id(),
                base.subject(),
                normalizeStatusForApi(base.status()),
                base.startsAt(),
                ...
                base.conversationId(),
                base.assignedUserId(),
                base.assignedUserName(),
                base.requiresDeposit(),
                base.depositAmount(),
                base.paymentStatus(),
                findStatusHistory(businessId, bookingId),
                findPublicLinks(businessId, bookingId),
                findReminders(businessId, bookingId),
                findEmailLogs(businessId, bookingId),
    ...
    public List<BookingStatusHistoryResponse> findStatusHistory(UUID businessId, UUID bookingId) {
        return jdbcTemplate.query(
                """
                        ...
                        """,
                bookingParameters(businessId, bookingId),
                (resultSet, rowNum) -> new BookingStatusHistoryResponse(
                        resultSet.getObject("id", UUID.class),
                        normalizeStatusForApi(resultSet.getString("previous_status")),
                        normalizeStatusForApi(resultSet.getString("new_status")),
    ...
    public List<BookingPublicLinkSummaryResponse> findPublicLinks(UUID businessId, UUID bookingId) {
        return jdbcTemplate.query(
                """
                        ...
                        """,
                bookingParameters(businessId, bookingId),
                (resultSet, rowNum) -> new BookingPublicLinkSummaryResponse(
                        resultSet.getObject("id", UUID.class),
    ...
    public List<BookingReminderResponse> findReminders(UUID businessId, UUID bookingId) {
        return jdbcTemplate.query(
                """
                        ...
                        """,
                bookingParameters(businessId, bookingId),
                (resultSet, rowNum) -> new BookingReminderResponse(
                        resultSet.getObject("id", UUID.class),
    ...
    public List<BookingEmailLogResponse> findEmailLogs(UUID businessId, UUID bookingId) {
        return jdbcTemplate.query(
                """
                        ...
                        """,
                bookingParameters(businessId, bookingId),
                (resultSet, rowNum) -> new BookingEmailLogResponse(
                        resultSet.getObject("id", UUID.class),
    ...
    public List<BookingPaymentResponse> findPayments(UUID businessId, UUID bookingId) {
        return jdbcTemplate.query(
                """
                        ...
                        """,
                bookingParameters(businessId, bookingId),
                (resultSet, rowNum) -> new BookingPaymentResponse(
                        resultSet.getObject("id", UUID.class),
    ...
    public LeadContextRecord findLeadContext(UUID businessId, UUID leadId) {
        List<LeadContextRecord> items = jdbcTemplate.query(
                ...
                (resultSet, rowNum) -> new LeadContextRecord(
                        resultSet.getObject("id", UUID.class),
                        resultSet.getObject("customer_id", UUID.class),
    ...
    private QueryParts buildListQuery(
            UUID businessId,
            OffsetDateTime from,
            OffsetDateTime to,
            String search,
    ...
    private RowMapper<BookingSummaryResponse> bookingSummaryRowMapper() {
        return (resultSet, rowNum) -> new BookingSummaryResponse(
                resultSet.getObject("id", UUID.class),
                resultSet.getString("subject"),
                resultSet.getString("status"),
    ...
    private RowMapper<BookingDetailResponse> bookingDetailRowMapper() {
        return (resultSet, rowNum) -> new BookingDetailResponse(
                resultSet.getObject("id", UUID.class),
                resultSet.getString("subject"),
                resultSet.getString("status"),
                resultSet.getObject("starts_at", OffsetDateTime.class),
    ...
    public record LeadContextRecord(
            UUID id,
            UUID customerId,
            UUID conversationId,
            UUID assignedUserId,
