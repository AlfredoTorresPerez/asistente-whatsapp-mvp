...
public class BookingConfirmationJdbcRepository {
    ...
    public ConfirmationLinkRecord findByTokenHash(String tokenHash) {
        return findOneLink("where l.token_hash = :tokenHash", new MapSqlParameterSource().addValue("tokenHash", tokenHash));
    }
    ...
    public UUID insertLink(UUID businessId, UUID bookingId, String tokenHash, String confirmationUrl, OffsetDateTime expiresAt) {
        ...
        jdbcTemplate.update(
                ...
                new MapSqlParameterSource()
                        ...
                        .addValue("confirmationUrl", confirmationUrl)
    ...
    public boolean hasOverlappingActiveBooking(UUID businessId, UUID bookingId, UUID locationId, OffsetDateTime startsAt, OffsetDateTime endsAt) {
        if (locationId == null) {
            return false;
        }
    ...
    private RowMapper<ConfirmationBookingRecord> bookingRowMapper() {
        return (resultSet, rowNum) -> new ConfirmationBookingRecord(
                ...
                resultSet.getObject("professional_id", UUID.class),
    ...
    private RowMapper<ConfirmationLinkRecord> linkRowMapper() {
        return (resultSet, rowNum) -> new ConfirmationLinkRecord(
                resultSet.getObject("link_id", UUID.class),
                resultSet.getObject("business_id", UUID.class),
                resultSet.getObject("booking_id", UUID.class),
                resultSet.getString("link_status"),
                resultSet.getString("confirmation_url"),
