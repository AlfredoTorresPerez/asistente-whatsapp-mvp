...
public record CreateBookingRequest(
        ...
        String subject,
        UUID customerId,
        @Size(max = 80, message = "customerFirstName no puede superar 80 caracteres")
        String customerFirstName,
        @Size(max = 80, message = "customerLastName no puede superar 80 caracteres")
        ...
        @Email(message = "customerEmail debe tener un formato valido")
