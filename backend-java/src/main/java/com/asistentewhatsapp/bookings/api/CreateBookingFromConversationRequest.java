...
public record CreateBookingFromConversationRequest(
		@NotBlank(message = "subject es obligatorio") @Size(max = 160, message = "subject no puede superar 160 caracteres") String subject,
		UUID leadId, UUID assignedUserId,
		@Size(max = 30, message = "status no puede superar 30 caracteres") String status,
