...
public class BookingSyncProperties {
	...
	public boolean isPhonePlaintextEnabled() {
		return phonePlaintextEnabled;
	}
	public void setPhonePlaintextEnabled(boolean phonePlaintextEnabled) {
		this.phonePlaintextEnabled = phonePlaintextEnabled;
	}

	public int getEventMaxAttempts() {
		return eventMaxAttempts;
	}
	public void setEventMaxAttempts(int eventMaxAttempts) {
		this.eventMaxAttempts = eventMaxAttempts;
	}
	...
	public long getEventProcessingTimeoutMs() {
		return eventProcessingTimeoutMs;
	}
	public void setEventProcessingTimeoutMs(long eventProcessingTimeoutMs) {
		this.eventProcessingTimeoutMs = eventProcessingTimeoutMs;
	}

	public long getEventWorkerIntervalMs() {
		return eventWorkerIntervalMs;
	}
	public void setEventWorkerIntervalMs(long eventWorkerIntervalMs) {
		this.eventWorkerIntervalMs = eventWorkerIntervalMs;
	}
