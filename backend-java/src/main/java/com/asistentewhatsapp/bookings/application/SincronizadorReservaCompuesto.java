...
public class SincronizadorReservaCompuesto implements SincronizadorReservaMotorReglas {
    ...
    public void sincronizarReserva(UUID businessId, UUID bookingId,
        ...
        local.sincronizarReserva(businessId, bookingId, customerPhone, customerName,
                serviceName, locationName, professionalName, startsAt, durationMinutes,
                bookingStatus, conversationId, channelOrigin, originIntent, traceId);

        eventos.sincronizarReserva(businessId, bookingId, customerPhone, customerName,
                serviceName, locationName, professionalName, startsAt, durationMinutes,
                bookingStatus, conversationId, channelOrigin, originIntent, traceId);
