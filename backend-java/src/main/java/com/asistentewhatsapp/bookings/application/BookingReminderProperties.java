...
public class BookingReminderProperties {
	...
	public int getWorkerIntervalMs() {
		return workerIntervalMs;
	}
	public void setWorkerIntervalMs(int workerIntervalMs) {
	...
	public int getMinimumRemainingHours() {
		return minimumRemainingHours;
	}
	public void setMinimumRemainingHours(int minimumRemainingHours) {
		this.minimumRemainingHours = minimumRemainingHours;
	}
