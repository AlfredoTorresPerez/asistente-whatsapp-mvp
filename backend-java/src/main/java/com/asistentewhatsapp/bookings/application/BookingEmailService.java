...
public class BookingEmailService {
    ...
    public OffsetDateTime sendBookingEmail(UUID businessId, UUID bookingId, String recipientEmail, String templateKey,
        ...
        jdbcTemplate.update(
                ...
                new MapSqlParameterSource()
                        .addValue("id", startedLogId)
                        .addValue("status", simulated ? "SIMULATED" : "SENT")
                        .addValue("simulation", simulated)
    ...
    public String buildAppointmentEmailBody(String greetingName, String actionText, String serviceName, String startsAtText,
            String locationName, String professionalName, String roomName, String primaryUrl, String note) {
        return """
                %s
                ...
                """.formatted(
                fromName,
                greetingName == null || greetingName.isBlank() ? "cliente" : greetingName,
                actionText,
                ...
                valueOrFallback(roomName, "No requerida"),
    ...
    private UUID insertLog(UUID businessId, UUID bookingId, String recipientEmail, String subject, String templateKey,
        ...
        jdbcTemplate.update(
                ...
                new MapSqlParameterSource()
                        ...
                        .addValue("templateKey", templateKey)
                        .addValue("status", status)
                        .addValue("simulation", simulation)
                        .addValue("failureReason", failureReason)
                        .addValue("bodyPreview", truncate(body, 2000))
                        .addValue("sentAt", sentAt));
        return id;
    }
