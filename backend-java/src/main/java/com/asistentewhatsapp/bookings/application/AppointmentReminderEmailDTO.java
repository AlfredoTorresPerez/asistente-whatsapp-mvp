...
public class AppointmentReminderEmailDTO {
    ...
    public int getMinimumNoticeHours() { return minimumNoticeHours; }
    public void setMinimumNoticeHours(int minimumNoticeHours) { this.minimumNoticeHours = minimumNoticeHours; }
}
