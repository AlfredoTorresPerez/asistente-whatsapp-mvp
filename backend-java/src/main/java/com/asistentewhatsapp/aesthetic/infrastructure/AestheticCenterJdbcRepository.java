...
public class AestheticCenterJdbcRepository {
    ...
    public PagedResponse<AestheticCategoryResponse> findServiceCategories(
            UUID businessId, int page, int size, Boolean active) {
        return findCategories("aesthetic_service_category", businessId, page, size, active);
    }

    public PagedResponse<AestheticCategoryResponse> findProductCategories(
            UUID businessId, int page, int size, Boolean active) {
        return findCategories("aesthetic_product_category", businessId, page, size, active);
    }

    private PagedResponse<AestheticCategoryResponse> findCategories(
            String tableName, UUID businessId, int page, int size, Boolean active) {
    ...
    public PagedResponse<AestheticServiceResponse> findServices(
            UUID businessId,
            int page,
            int size,
            String search,
        ...
        List<AestheticServiceResponse> items = jdbcTemplate.query(
                serviceSelect() + queryParts.fromAndWhere() + """
    ...
    public AestheticServiceResponse updateService(UUID businessId, UUID serviceId, UpsertAestheticServiceRequest request) {
    ...
    public Optional<AestheticServiceResponse> findServiceByText(UUID businessId, String normalizedText) {
        List<AestheticServiceResponse> items = jdbcTemplate.query(
                ...
                new MapSqlParameterSource()
                        .addValue("businessId", businessId)
                        .addValue("search", "%" + normalizedText + "%"),
                serviceRowMapper());
        return items.stream().findFirst();
    }

    public PagedResponse<AestheticProductResponse> findProducts(
            UUID businessId,
            int page,
            int size,
            String search,
        ...
        List<AestheticProductResponse> items = jdbcTemplate.query(
                productSelect() + queryParts.fromAndWhere() + """
    ...
    public AestheticProductResponse updateProduct(UUID businessId, UUID productId, UpsertAestheticProductRequest request) {
        int updated = jdbcTemplate.update(
                """
    ...
    public PagedResponse<AestheticBusinessRuleResponse> findRules(
            UUID businessId,
            int page,
            int size,
            String ruleType,
    ...
    public AestheticBusinessRuleResponse updateRule(UUID businessId, UUID ruleId, UpsertAestheticBusinessRuleRequest request) {
        int updated = jdbcTemplate.update(
                """
    ...
    public List<AestheticPromotionSummary> findActivePromotions(UUID businessId) {
        return jdbcTemplate.query(
                ...
                (resultSet, rowNumber) -> new AestheticPromotionSummary(
    ...
    public void insertIntentLog(
        ...
        jdbcTemplate.update(
                ...
                new MapSqlParameterSource()
                        ...
                        .addValue("intent", response.intencion())
                        .addValue("confidence", response.confianza())
                        .addValue("entities", toJson(response.entidades()))
                        ...
                        .addValue("suggestedResponse", response.respuestaSugerida())
                        .addValue("modelName", response.modelo()));
    }
    ...
    public PagedResponse<AestheticIntentLogResponse> findIntentLogs(UUID businessId, int page, int size) {
        ...
        Long totalItems = jdbcTemplate.queryForObject(
                "select count(*) from aesthetic_intent_log where business_id = :businessId",
                parameters,
                Long.class);
        long resolvedTotalItems = totalItems == null ? 0 : totalItems;
    ...
    private MapSqlParameterSource serviceParameters(
            UUID businessId, UUID serviceId, UpsertAestheticServiceRequest request) {
        return new MapSqlParameterSource()
                .addValue("businessId", businessId)
                .addValue("serviceId", serviceId)
                .addValue("categoryCode", request.categoryCode())
                .addValue("code", request.code())
                .addValue("name", request.name())
                .addValue("description", request.description())
                .addValue("durationMinutes", request.durationMinutes())
                .addValue("priceBase", request.priceBase())
                .addValue("professionalRequired", request.professionalRequired())
                .addValue("supplies", request.supplies())
                .addValue("contraindications", request.contraindications())
    ...
    private MapSqlParameterSource productParameters(
            UUID businessId, UUID productId, UpsertAestheticProductRequest request) {
        return new MapSqlParameterSource()
                .addValue("businessId", businessId)
                .addValue("productId", productId)
                .addValue("categoryCode", request.categoryCode())
                ...
                .addValue("stockMinimum", request.stockMinimum())
                .addValue("supplier", request.supplier())
                ...
                .addValue("usageRestrictions", request.usageRestrictions())
                .addValue("active", request.active());
    }

    private MapSqlParameterSource ruleParameters(
            UUID businessId, UUID ruleId, UpsertAestheticBusinessRuleRequest request) {
        return new MapSqlParameterSource()
                .addValue("businessId", businessId)
                .addValue("ruleId", ruleId)
                .addValue("code", request.code())
    ...
    private QueryParts buildProductsQuery(
            UUID businessId,
            String search,
            String categoryCode,
            Boolean active,
    ...
    private RowMapper<AestheticServiceResponse> serviceRowMapper() {
        return (resultSet, rowNumber) -> new AestheticServiceResponse(
                resultSet.getObject("id", UUID.class),
                resultSet.getString("code"),
                resultSet.getString("name"),
                resultSet.getString("description"),
                ...
                resultSet.getBigDecimal("price_base"),
                resultSet.getString("professional_required"),
                resultSet.getString("supplies"),
                resultSet.getString("contraindications"),
                resultSet.getString("availability_rules"),
                resultSet.getString("booking_rules"),
                resultSet.getString("cancellation_rules"),
                resultSet.getString("aftercare_recommendations"),
                resultSet.getBoolean("requires_prior_evaluation"),
                resultSet.getBoolean("requires_informed_consent"),
                resultSet.getBoolean("active"),
    ...
    private RowMapper<AestheticProductResponse> productRowMapper() {
        return (resultSet, rowNumber) -> new AestheticProductResponse(
                resultSet.getObject("id", UUID.class),
                resultSet.getString("code"),
                resultSet.getString("name"),
                resultSet.getString("description"),
                ...
                resultSet.getInt("stock_minimum"),
                resultSet.getString("supplier"),
                resultSet.getObject("expiration_date", java.time.LocalDate.class),
                resultSet.getString("compatible_services"),
                resultSet.getString("recommendation_rules"),
                resultSet.getString("cross_sell_rules"),
                resultSet.getString("usage_restrictions"),
    ...
    private RowMapper<AestheticBusinessRuleResponse> ruleRowMapper() {
        return (resultSet, rowNumber) -> new AestheticBusinessRuleResponse(
                resultSet.getObject("id", UUID.class),
                resultSet.getString("code"),
                resultSet.getString("name"),
                ...
                resultSet.getBoolean("active"),
                resultSet.getString("rule_payload"),
                resultSet.getObject("created_at", OffsetDateTime.class),
                resultSet.getObject("updated_at", OffsetDateTime.class));
    }

    private RowMapper<AestheticIntentLogResponse> intentLogRowMapper() {
        return (resultSet, rowNumber) -> new AestheticIntentLogResponse(
                resultSet.getObject("id", UUID.class),
                resultSet.getString("source_message"),
                resultSet.getString("intent"),
                resultSet.getBigDecimal("confidence"),
                resultSet.getString("entities"),
                resultSet.getBoolean("requires_database_lookup"),
                resultSet.getBoolean("requires_human_handoff"),
