...
public record UpsertAestheticServiceRequest(@Size(max = 70, message = "code no debe superar 70 caracteres") String code,
		...
		@NotBlank(message = "professionalRequired es obligatorio") @Size(max = 160, message = "professionalRequired no debe superar 160 caracteres") String professionalRequired,
		...
		Boolean requiresPriorEvaluation, Boolean requiresInformedConsent, Boolean active) {
}
