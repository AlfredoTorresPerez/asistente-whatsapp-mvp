...
public class AestheticCenterController {
	...
	public AestheticServiceResponse getService(@AuthenticationPrincipal AuthenticatedUser authenticatedUser,
	...
	@PostMapping(value = {"/api/esthetic/services",
			"/api/v1/esthetic/services"}, consumes = MediaType.APPLICATION_JSON_VALUE)
	public AestheticServiceResponse createService(@AuthenticationPrincipal AuthenticatedUser authenticatedUser,
	...
	@PreAuthorize("hasPermission(#authenticatedUser.businessId(), 'CATALOG_MANAGE')")
	@PutMapping(value = {"/api/esthetic/services/{serviceId}",
			"/api/v1/esthetic/services/{serviceId}"}, consumes = MediaType.APPLICATION_JSON_VALUE)
	public AestheticServiceResponse updateService(@AuthenticationPrincipal AuthenticatedUser authenticatedUser,
			@PathVariable UUID serviceId, @Valid @RequestBody UpsertAestheticServiceRequest request) {
	...
	public PagedResponse<AestheticProductResponse> listProducts(
		...
		return aestheticCenterService.listProducts(authenticatedUser, page, size, search, categoryCode, active,
				lowStockOnly);
	}

	@PreAuthorize("hasPermission(#authenticatedUser.businessId(), 'CATALOG_VIEW')")
	@GetMapping({"/api/esthetic/products/{productId}", "/api/v1/esthetic/products/{productId}"})
	public AestheticProductResponse getProduct(@AuthenticationPrincipal AuthenticatedUser authenticatedUser,
			@PathVariable UUID productId) {
		return aestheticCenterService.getProduct(authenticatedUser, productId);
	}

	@PreAuthorize("hasPermission(#authenticatedUser.businessId(), 'CATALOG_MANAGE')")
	@PostMapping(value = {"/api/esthetic/products",
			"/api/v1/esthetic/products"}, consumes = MediaType.APPLICATION_JSON_VALUE)
	public AestheticProductResponse createProduct(@AuthenticationPrincipal AuthenticatedUser authenticatedUser,
	...
	@PreAuthorize("hasPermission(#authenticatedUser.businessId(), 'CATALOG_MANAGE')")
	@PutMapping(value = {"/api/esthetic/products/{productId}",
			"/api/v1/esthetic/products/{productId}"}, consumes = MediaType.APPLICATION_JSON_VALUE)
	public AestheticProductResponse updateProduct(@AuthenticationPrincipal AuthenticatedUser authenticatedUser,
			@PathVariable UUID productId, @Valid @RequestBody UpsertAestheticProductRequest request) {
	...
	public PagedResponse<AestheticBusinessRuleResponse> listRules(
			@AuthenticationPrincipal AuthenticatedUser authenticatedUser, @RequestParam(defaultValue = "0") int page,
			@RequestParam(defaultValue = "10") int size, @RequestParam(required = false) String ruleType,
	...
	public AestheticBusinessRuleResponse getRule(@AuthenticationPrincipal AuthenticatedUser authenticatedUser,
			@PathVariable UUID ruleId) {
		return aestheticCenterService.getRule(authenticatedUser, ruleId);
	}

	@PreAuthorize("hasPermission(#authenticatedUser.businessId(), 'AUTOMATION_MANAGE')")
	@PostMapping(value = {"/api/esthetic/rules", "/api/v1/esthetic/rules"}, consumes = MediaType.APPLICATION_JSON_VALUE)
	public AestheticBusinessRuleResponse createRule(@AuthenticationPrincipal AuthenticatedUser authenticatedUser,
	...
	@PreAuthorize("hasPermission(#authenticatedUser.businessId(), 'AUTOMATION_MANAGE')")
	@PutMapping(value = {"/api/esthetic/rules/{ruleId}",
			"/api/v1/esthetic/rules/{ruleId}"}, consumes = MediaType.APPLICATION_JSON_VALUE)
	public AestheticBusinessRuleResponse updateRule(@AuthenticationPrincipal AuthenticatedUser authenticatedUser,
			@PathVariable UUID ruleId, @Valid @RequestBody UpsertAestheticBusinessRuleRequest request) {
		return aestheticCenterService.updateRule(authenticatedUser, ruleId, request);
	}

	@PreAuthorize("hasPermission(#authenticatedUser.businessId(), 'AUTOMATION_MANAGE')")
	@PostMapping(value = {"/api/esthetic/intent/analyze",
			"/api/v1/esthetic/intent/analyze"}, consumes = MediaType.APPLICATION_JSON_VALUE)
	public IntentAnalysisResponse analyzeIntent(@AuthenticationPrincipal AuthenticatedUser authenticatedUser,
