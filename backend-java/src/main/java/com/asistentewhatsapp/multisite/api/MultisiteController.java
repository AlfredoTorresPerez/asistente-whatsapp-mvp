...
public class MultisiteController {
	...
	@GetMapping("/summary")
	public List<MultisiteLocationSummaryResponse> summary(
	...
	public List<MultisiteProfessionalResponse> professionals(
			@AuthenticationPrincipal AuthenticatedUser authenticatedUser) {
	...
	public List<ProfessionalScheduleResponse> schedules(@AuthenticationPrincipal AuthenticatedUser authenticatedUser,
			@RequestParam(required = false) UUID locationId) {
	...
	public List<MultisiteChannelResponse> updateChannelLocation(
			@AuthenticationPrincipal AuthenticatedUser authenticatedUser, @PathVariable UUID channelId,
