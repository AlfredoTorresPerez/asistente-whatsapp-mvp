...
values
    ('60000000-0000-0000-0000-000000000001', '11111111-1111-1111-1111-111111111111', 'FACIAL', 'Faciales', 'Servicios de limpieza e hidratacion facial.', true),
...
values
    ('61000000-0000-0000-0000-000000000001', '11111111-1111-1111-1111-111111111111', '60000000-0000-0000-0000-000000000001', 'SERVICE', 'Limpieza Facial Profunda', 'FAC-001', 'Servicio de limpieza profunda con extraccion y mascarilla.', 34990.00, 60, true),
...
values
    ('62000000-0000-0000-0000-000000000001', '11111111-1111-1111-1111-111111111111', 'Seguimiento 24h', 'FOLLOW_UP', 'Hola {{customer_name}}, gracias por escribir a Centro Estetico Bella. Si quieres, te ayudo a reservar tu evaluacion.', true),
...
values
    ('63000000-0000-0000-0000-000000000001', '11111111-1111-1111-1111-111111111111', 'Sofia', 'Rojas', 'Sofia Rojas', '+56911112222', '+56911112222', 'sofia@demo.cl', true),
...
values
    (
        ...
        'Quiero saber el precio de la limpieza facial.',
        '2026-05-23T18:05:00Z',
        null
    ),
    (
...
values
    (
        ...
        'INBOUND',
        'TEXT',
        'Hola, quiero saber el precio de la limpieza facial.',
        'RECEIVED',
        null,
        'evt-demo-1001',
        null,
    ...
    (
        ...
        'OUTBOUND',
        'TEXT',
        'Hola Sofia, la limpieza facial profunda tiene un valor de $34.990. Si quieres, te ayudo a reservar.',
        'DELIVERED',
        'whatsapp-web-msg-1001',
        'ack-demo-1001',
        '2026-05-23T18:15:00Z',
        null,
        null,
...
values
    (
        ...
        'sofia@demo.cl',
        'QUALIFIED',
        'Interesada en reservar una limpieza facial para la proxima semana.',
        '40000000-0000-0000-0000-000000000001',
        true
    ),
    (
        ...
        'paula@demo.cl',
        'NEW',
        'Pidio informacion por depilacion laser.',
        '40000000-0000-0000-0000-000000000001',
        true
    )
on conflict do nothing;
...
values (
    ...
    '66000000-0000-0000-0000-000000000001',
    '40000000-0000-0000-0000-000000000001',
    'Cliente con alta intencion de compra. Prefiere horario tarde.'
)
on conflict do nothing;
...
values
    (
        ...
        'Confirmar por WhatsApp una hora antes.',
        null
    ),
    (
        ...
        null,
        '40000000-0000-0000-0000-000000000001',
        'Evaluacion depilacion laser',
        'RESCHEDULED',
        '2026-05-29T17:00:00Z',
        30,
        'Sucursal Providencia',
        'Cliente solicito mover la cita por trabajo.',
        null
    )
on conflict do nothing;
...
values (
    ...
    'CLP',
    '2026-06-05',
    'Pedido demo creado desde la conversacion de Sofia.'
)
on conflict do nothing;
...
values (
    ...
    20000.00,
    'TRANSFER',
    '2026-05-23T19:10:00Z',
    'TRX-781',
    'Abono inicial del pedido demo.'
)
on conflict do nothing;
...
values (
    ...
    'TEST',
    'SUCCESS',
    '{"sampleMessage":"Quiero saber el precio"}'::jsonb,
    '{"matched":true,"action":"SEND_TEMPLATE","delayMinutes":5}'::jsonb,
...
values (
    '69600000-0000-0000-0000-000000000001',
    '11111111-1111-1111-1111-111111111111',
    '69500000-0000-0000-0000-000000000001',
    'evt-demo-1001',
    'MESSAGE_RECEIVED',
    '{"from":"+56911112222","body":"Hola, quiero saber el precio de la limpieza facial."}'::jsonb,
    '2026-05-23T18:10:05Z',
    '2026-05-23T18:10:07Z',
    'PROCESSED'
)
...
values (
    '69700000-0000-0000-0000-000000000001',
    '11111111-1111-1111-1111-111111111111',
    '65000000-0000-0000-0000-000000000002',
    'DELIVERED',
    'ack-demo-1001',
    '{"status":"DELIVERED"}'::jsonb,
    '2026-05-23T18:15:10Z'
)
on conflict do nothing;
...
values (
    '69800000-0000-0000-0000-000000000001',
    '11111111-1111-1111-1111-111111111111',
    '40000000-0000-0000-0000-000000000001',
    'NEW_MESSAGE',
    'UNREAD',
...
values
    (
        ...
        'USER_ACCOUNT',
        '40000000-0000-0000-0000-000000000001',
        'Usuario administrador demo creado.',
        '{"email":"admin@demo.cl"}'::jsonb,
        '2026-05-23T17:50:00Z'
    ),
    (
        '69900000-0000-0000-0000-000000000002',
        '11111111-1111-1111-1111-111111111111',
        '40000000-0000-0000-0000-000000000001',
        'RULE_TESTED',
        'AUTOMATION_RULE',
        '69300000-0000-0000-0000-000000000001',
        'Regla demo probada con coincidencia positiva.',
        '{"matched":true}'::jsonb,
        '2026-05-23T19:20:01Z'
    )
on conflict do nothing;
