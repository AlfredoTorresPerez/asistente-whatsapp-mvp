...
class AestheticCenterControllerTest {
    ...
    void shouldListAestheticServices() throws Exception {
        when(aestheticCenterService.listServices(nullable(AuthenticatedUser.class), eq(0), eq(10), isNull(), isNull(), isNull()))
                .thenReturn(new PagedResponse<>(
                        List.of(new AestheticServiceResponse(
                                UUID.fromString("73000000-0000-0000-0000-000000000001"),
                                "FAC-LIMPIEZA",
                                "Limpieza facial profunda",
                                "Limpieza facial con higienizacion.",
                                "FACIAL",
                                ...
                                false,
                                true,
                                OffsetDateTime.parse("2026-05-29T10:00:00Z"),
                                OffsetDateTime.parse("2026-05-29T10:00:00Z"))),
                        0,
                        50,
                        1,
        ...
        mockMvc.perform(get("/api/v1/esthetic/services"))
    ...
    void shouldAnalyzeIntent() throws Exception {
        ...
        when(aestheticCenterService.analyzeIntent(nullable(AuthenticatedUser.class), any(IntentAnalysisRequest.class)))
                .thenReturn(new IntentAnalysisResponse(
                        "derivar_atencion_humana",
                        BigDecimal.valueOf(0.95),
                        new IntentEntitiesResponse("Drenaje linfatico", null, null, null, null, null),
                        true,
                        true,
        ...
        mockMvc.perform(post("/api/v1/esthetic/intent/analyze")
