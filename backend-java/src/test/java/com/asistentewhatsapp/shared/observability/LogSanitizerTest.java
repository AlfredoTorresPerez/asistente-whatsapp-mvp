...
class LogSanitizerTest {
    ...
    void messageSummaryOmitsBodyByDefault() {
        String summary = LogSanitizer.messageSummary("message", "Hola Ana, confirma en http://localhost/reservas/confirmar/abc");

        assertThat(summary)
                .contains("messageLength=")
                .contains("messageContainsLink=true")
                .doesNotContain("Hola Ana")
                .doesNotContain("/abc");
    }

    @Test
    void masksPhoneExternalIdAndSensitiveMapValues() {
        String summary = LogSanitizer.summarizeMap(Map.of(
                "telefono", "+56912345678",
                "responseText", "Respuesta larga con link http://localhost/reservas/confirmar/token-real"));
        ...
        assertThat(summary)
                .contains("responseText=length=")
                .doesNotContain("token-real")
