    ...
    return (
      <div className="flex flex-col items-center justify-center rounded-2xl border border-dashed border-slate-200 bg-slate-50/50 p-8 text-center">
        ...
        <p className="mt-1 text-xs text-slate-500">
          Al posicionarte sobre una cita se mostrar&aacute; el detalle, la trazabilidad y las
  ...
  return (
    <div className="space-y-5">
      ...
      <div className="space-y-2.5">
        ...
        <Button fullWidth onClick={() => onViewHistory(selectedItem.bookingId)} variant="secondary">
