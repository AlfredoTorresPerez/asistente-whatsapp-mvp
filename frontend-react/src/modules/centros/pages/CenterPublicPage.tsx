...
export function CenterPublicPage() {
  ...
  const logoUrl = cfg.headerLogoUrl
  ...
  return (
    <div className="min-h-screen bg-white font-sans text-gray-900">
        ...
        <div className="mx-auto flex max-w-6xl items-center justify-between px-4 py-3 sm:py-4">
          ...
          <nav className="hidden items-center gap-6 md:flex" aria-label="Navegacion principal">
            ...
            <button
              ...
              aria-label={`Abrir conversacion de WhatsApp con ${company.name}`}
            >
      ...
      <main>
        ...
        {cfg.aboutTitle && (
          <section className="scroll-mt-20 py-16 md:py-24" style={{ backgroundColor: '#fdfaf7' }}>
        ...
        <section className="py-16 md:py-24" style={{ backgroundColor: '#fdfaf7' }}>
          <div className="mx-auto max-w-3xl px-4 text-center">
            ...
            <button
              ...
              className="mt-8 inline-flex items-center gap-2.5 rounded-2xl bg-[#25D366] px-8 py-4 text-lg font-bold text-white shadow-lg transition hover:bg-[#20BD5A] hover:shadow-xl"
            >
          ...
          <div className="grid gap-8 md:grid-cols-4">
            <div className="md:col-span-2">
              <div className="flex items-center gap-2">
                {logoUrl ? (
                  <img alt="Logo" className="h-8 w-auto rounded-lg" src={logoUrl} />
                ) : (
                  <div
      ...
      <button
        onClick={() => handleWhatsAppRedirect('flotante')}
        className="fixed bottom-6 right-6 z-50 flex h-14 w-14 items-center justify-center rounded-full bg-[#25D366] text-white shadow-2xl transition hover:bg-[#20BD5A] hover:shadow-xl focus:outline-none focus:ring-4 focus:ring-[#25D366]/50"
