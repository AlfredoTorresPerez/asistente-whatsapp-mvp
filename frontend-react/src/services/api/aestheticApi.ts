...
export function listAestheticServiceCategories(params: { page?: number; size?: number; active?: boolean } = {}) {
  return apiFetch<PagedResponse<AestheticCategoryResponse>>(`/esthetic/service-categories${toQueryString(params)}`)
}

export function listAestheticProductCategories(params: { page?: number; size?: number; active?: boolean } = {}) {
  return apiFetch<PagedResponse<AestheticCategoryResponse>>(`/esthetic/product-categories${toQueryString(params)}`)
}

export function listAestheticServices(params: {
  page?: number
  size?: number
  search?: string
  categoryCode?: string
  ...
  return apiFetch<PagedResponse<AestheticServiceResponse>>(`/esthetic/services${toQueryString(params)}`)
}
...
export function listAestheticProducts(params: {
  page?: number
  size?: number
  search?: string
  categoryCode?: string
  ...
  return apiFetch<PagedResponse<AestheticProductResponse>>(`/esthetic/products${toQueryString(params)}`)
}
...
export function listAestheticRules(params: {
  page?: number
  size?: number
  ruleType?: string
  active?: boolean
} = {}) {
  return apiFetch<PagedResponse<AestheticBusinessRuleResponse>>(`/esthetic/rules${toQueryString(params)}`)
}
...
export function listAestheticIntentLogs(params: { page?: number; size?: number } = {}) {
  return apiFetch<PagedResponse<AestheticIntentLogResponse>>(`/esthetic/intent/logs${toQueryString(params)}`)
}
