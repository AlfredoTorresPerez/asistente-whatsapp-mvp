...
Write-Host ""
Write-Host "Ejecutando test funcional V23.4.3 contra: $analyzeUrl"
...
$outDir = Join-Path (Get-Location) "resultados-test-ia-v23-4-3"
New-Item -ItemType Directory -Force -Path $outDir | Out-Null
$timestamp = Get-Date -Format "yyyyMMdd_HHmmss"
$csvPath = Join-Path $outDir "resultado_test_ia_negocio_v23_4_3_$timestamp.csv"
$jsonPath = Join-Path $outDir "resultado_test_ia_negocio_v23_4_3_$timestamp.json"
$htmlPath = Join-Path $outDir "resultado_test_ia_negocio_v23_4_3_$timestamp.html"
...
<head>
<meta charset="utf-8" />
<title>Resultado test IA negocio V23.4.3</title>
<style>
...
<body>
<h1>Resultado test IA negocio V23.4.3</h1>
...
Write-Host "docker compose -f docker-compose.local.yml logs --tail=1000 backend-java > logs_backend_v23_4_3.txt"
