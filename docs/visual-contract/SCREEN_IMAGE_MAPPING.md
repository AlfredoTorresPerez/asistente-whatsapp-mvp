...
| Pantalla | Ruta frontend | Imagen de referencia | Tipo de layout | Componentes visuales obligatorios | Variantes permitidas | Estado de implementacion |
| --- | --- | --- | --- | --- | --- | --- |
| AdministrationPage | `/admin` | `10_administracion_seguridad_usuarios_roles_integraciones_2fa_accesos.png` | Configuracion | cards resumen, tabs o bloques por subseccion, CTA a empresa, usuarios, WhatsApp Web y seguridad | orden de cards | Placeholder |
...
| WhatsAppWebConnectionPage | `/admin/whatsapp-web` | `10_administracion_seguridad_usuarios_roles_integraciones_2fa_accesos.png` | Configuracion | card de conexion, numero, estado, QR o dispositivo, CTA conectar/desconectar | estados connected/pending/error | Placeholder |
