...
4. `docker-compose.local.yml`, `docker-compose.prod.yml` y `docker-compose.yml` usan `build.network: host` para que la fase de construccion use la red del host Docker cuando sea posible.
