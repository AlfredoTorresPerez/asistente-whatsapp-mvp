...
function Repair-TextEncoding([string]$Value) {
    ...
    if ($fixed -match "Ã|Â|â") {
        try {
            ...
            # Mantener el valor original y aplicar reemplazos manuales abajo.
        }
    }
    ...
    $replacements = [ordered]@{
        ...
        "Ã±" = "ñ"; "Ã‘" = "Ñ"; "Â¿" = "¿"; "Â¡" = "¡"; "Â" = "";
        "â" = "'"; "â" = '"'; "â" = '"'; "â" = "-"; "â" = "-";
        "â" = "OK"; "âœ…" = "OK"; "â" = "ERROR"; "â�Œ" = "ERROR"
    }

    foreach ($entry in $replacements.GetEnumerator()) {
        $fixed = $fixed.Replace($entry.Key, $entry.Value)
    }
    return $fixed
}
...
$cases = @(
    ...
    @{ Id="A04"; Categoria="Servicio facial con sinonimo"; Pregunta="Me gustaria una limpieza de rostro esta semana"; IntentAny=@("reservar_hora", "consultar_disponibilidad_fecha"); Min=70; Must=@("limpieza facial", "esta semana"); MustNot=@("depilacion rostro", "no entendi", "que servicio quieres") },
...
Write-Host ""
Write-Host "Ejecutando test funcional V23.3 contra: $analyzeUrl"
...
$outDir = Join-Path (Get-Location) "resultados-test-ia-v23-3"
New-Item -ItemType Directory -Force -Path $outDir | Out-Null
$timestamp = Get-Date -Format "yyyyMMdd_HHmmss"
$csvPath = Join-Path $outDir "resultado_test_ia_negocio_v23_3_$timestamp.csv"
$jsonPath = Join-Path $outDir "resultado_test_ia_negocio_v23_3_$timestamp.json"
$htmlPath = Join-Path $outDir "resultado_test_ia_negocio_v23_3_$timestamp.html"
...
<head>
<meta charset="utf-8" />
<title>Resultado test IA negocio V23.3</title>
<style>
...
<body>
<h1>Resultado test IA negocio V23.3</h1>
